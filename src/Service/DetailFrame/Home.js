...
const Home = () => {
   ...
   return(
        ...
        <section class = "detail-sec">
                    ...
                    <h1 id ="objective"  class="padTop" data-aos ="fade-right">Career Objective</h1>
                    <div style={paddingTop}  data-aos ="fade-up"  class ="container">
                    ...
                    <h1 id ="experience"  class="padTop" data-aos ="fade-right">Experience</h1>
                    <div style={paddingTop}  data-aos ="fade-up"  class ="container">
                            ...
                            " testing as well as development design.", btnName :"Jul 2017 - Present"}}/>
                    </div>
                    ...
                    <div style={paddingTop}  data-aos ="fade-up"  class ="container">
                        <CustomCard attrib = {{title:"Hue", icon:"fa fa-briefcase fa-1x", isimage:false, submenu:false, isProg:false, btnshw:true, 
                         ...
                         <CustomCard attrib = {{title:"E-commerce", icon:"fa fa-briefcase fa-1x", isimage:false, submenu:false, isProg:false, btnshw:true, 
                                    ...
                                    " features according to client’s specifications.", 
                                    btnName :"Project 2"}}/>
                        ...
                        <CustomCard attrib = {{title:"Automation and Tool Development", icon:"fa fa-briefcase fa-1x", isimage:false, submenu:false, isProg:false, btnshw:true, 
                                    ...
                                    "desktop or web applications in order to reduce developer's or tester's development time.", 
                                    btnName :"Project 4"}}/>
                        <CustomCard attrib = {{title:"IntraWeb", icon:"fa fa-briefcase fa-1x", isimage:false, submenu:false, isProg:false, btnshw:true, 
                                    ...
                                    "of a web application created using a set of real time automation tools ", 
                                    btnName :"Project 5"}}/>
                           
                    </div>
                    <h1 id ="achievement" class="padTop" data-aos ="fade-right">Achievements</h1>
                    <div style={paddingTop}  data-aos ="fade-up"  class ="container">
